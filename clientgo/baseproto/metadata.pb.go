...
type Metadata struct {
	...
	TimeUpdate   int32  `protobuf:"varint,5,opt,name=time_update,json=timeUpdate,proto3" json:"time_update,omitempty"`
	DbIdUpdated  int32  `protobuf:"varint,6,opt,name=db_id_updated,json=dbIdUpdated,proto3" json:"db_id_updated,omitempty"`
	LastTxnId    int32  `protobuf:"varint,7,opt,name=last_txn_id,json=lastTxnId,proto3" json:"last_txn_id,omitempty"`
...
func (x *Metadata) GetUpdateCount() int32 {
	if x != nil {
...
func (x *Metadata) GetTimeUpdate() int32 {
	if x != nil {
		return x.TimeUpdate
	}
	return 0
...
func (x *Metadata) GetLastTxnId() int32 {
	if x != nil {
		return x.LastTxnId
	}
	return 0
...
var file_metadata_proto_rawDesc = []byte{
	...
	0x05, 0x52, 0x0b, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x21,
	...
	0x78, 0x6e, 0x5f, 0x69, 0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x05, 0x52, 0x09, 0x6c, 0x61, 0x73,
