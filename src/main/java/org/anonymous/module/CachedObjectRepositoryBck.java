...
public class CachedObjectRepositoryBck implements AutoCloseable {

    private static final Logger LOGGER = LoggerFactory.getLogger(CachedObjectRepositoryBck.class);
    ...
    public CachedObjectRepositoryBck(ObjectRepository objectRepository) {
